...
describe(`stringifyByStream`, function() {
    ...
    it(`should return '${cobj}' when json.stringifyByStream(${cobj})`, async function() {
        let r = await json.stringifyByStream(obj)
        assert.strict.deepStrictEqual(r, cobj)
    })

    it(`should return '${carr}' when json.stringifyByStream(${carr})`, async function() {
        let r = await json.stringifyByStream(arr)
        assert.strict.deepStrictEqual(r, carr)
    })

    it(`should return '[1,"3","abc"]' when input [1, '3', 'abc']`, async function() {
        let r = await json.stringifyByStream([1, '3', 'abc'])
        let rr = '[1,"3","abc"]'
        assert.strict.deepStrictEqual(r, rr)
    })

    it(`should return '[1,"",null,null,[],{},"3","abc"]' when input [1, '', null, undefined, [], {}, '3', 'abc']`, async function() {
        let r = await json.stringifyByStream([1, '', null, undefined, [], {}, '3', 'abc'])
        let rr = '[1,"",null,null,[],{},"3","abc"]'
        assert.strict.deepStrictEqual(r, rr)
    })

    it(`should return '{"a":12.34,"b":"abc"}' when input { a: 12.34, b: 'abc' }`, async function() {
        let r = await json.stringifyByStream({ a: 12.34, b: 'abc' })
    ...
    it(`should return '{"a":12.34,"b":"abc","c":"","d":null,"f":[],"g":{}}' when input { a: 12.34, b: 'abc', c: '', d: null, e: undefined, f: [], g: {} }`, async function() {
        let r = await json.stringifyByStream({ a: 12.34, b: 'abc', c: '', d: null, e: undefined, f: [], g: {} })
        let rr = '{"a":12.34,"b":"abc","c":"","d":null,"f":[],"g":{}}'
        assert.strict.deepStrictEqual(r, rr)
    })

    it(`should return '123' when input 123`, async function() {
        let r = await json.stringifyByStream(123)
        let rr = '123'
        assert.strict.deepStrictEqual(r, rr)
    })

    it(`should return '123.456' when input 123.456`, async function() {
        let r = await json.stringifyByStream(123.456)
        let rr = '123.456'
        assert.strict.deepStrictEqual(r, rr)
    })
    ...
    it(`sould return 'true' when input true`, async function() {
        let r = await json.stringifyByStream(true)
        let rr = 'true'
        assert.strict.deepStrictEqual(r, rr)
    })

    it(`sould return '""' when input ''`, async function() {
        let r = await json.stringifyByStream('')
        let rr = '""'
        assert.strict.deepStrictEqual(r, rr)
    })
    ...
    it(`should return 'null' when input null`, async function() {
        let r = await json.stringifyByStream(null)
        let rr = 'null'
        assert.strict.deepStrictEqual(r, rr)
    })

    it(`should return '' when input undefined`, async function() {
        let r = await json.stringifyByStream(undefined)
        let rr = ''
        assert.strict.deepStrictEqual(r, rr)
    })
